"""
Aubo i5 SimpleMove 环境实例

从 demo_aubo_i5_simple_move.py 提取的环境创建函数
"""

from ..env_factory import make_sim_env
from mujoco_env.mujoco_env.tasks.single_move.aubo_i5_config import AuboI5Config
from mujoco_env.mujoco_env.tasks.single_move.single_move import SingleMoveTask


def make_aubo_i5_simple_move_env(mode='moveL', **kwargs):
    """
    创建 Aubo i5 SimpleMove 环境
    ...
    # 2. 创建机器人配置
    robot_config = AuboI5Config(
        controller_type=controller_type,
        control_freq=control_freq,
        mount_name=kwargs.pop("mount_name", "pedestal"),
        gripper_name=kwargs.pop("gripper_name", "assemble_axle"),
